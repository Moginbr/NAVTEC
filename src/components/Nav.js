  ...
  return (
    <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
      <div className='container mx-auto'>
        ...
        backdrop-blur-2x1 rounded-full max-w-[220px] 
        mx-auto px-5 flex justify-between items-center text-2x1 text-white/50'>
          ...
          <Link to='services' smooth={true} spy={true} className='cursor-pointer w-[60px] h-[60px] flex items-center justify-center'>
              <BiUser />
          </Link>
        </div>
      </div>
